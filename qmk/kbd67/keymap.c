...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_all(
        ...
        KC_TRNS, KC_NO, KC_UP, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_NO, KC_NO, KC_NO, RESET, KC_SLCK,
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_TRNS, KC_PAUS,
        KC_TRNS, KC_NO, KC_F13, KC_F14, KC_F15, KC_F16, KC_NO, KC_PSLS, KC_PAST, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_PGUP, KC_INS,
